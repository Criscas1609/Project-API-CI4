                        ...
                        <div class="col-lg-6">
                            <div class="card-body p-md-5 mx-md-4">
                                <div class="text-center">
                                    <img src="https://cdn.pixabay.com/photo/2022/12/31/06/52/apple-7688110_1280.png" style="width: 85px;" alt="logo">
                                    <h4 class="pb-1 mt-1 mb-5">New Product</h4>
                                </div>
      
                                <form method="POST" action="/new-product/complete" onsubmit="return validateForm()">
                                    ...
                                    <div class="mb-4 form-outline">
                                        ...
                                        <input type="text" id="location" name="location" class="form-control" required autocomplete="off">
                                    ...
                                    <div class="mb-4 form-outline">
                                        ...
                                        <textarea id="instruction" name="instruction" class="form-control" rows="5" required autocomplete="off"></textarea>
